#!/usr/bin/env python3
"""reference-author-clean — emits canonical CLEAN code for the requested task."""
...
VARIANT = "clean_code"  # one of: clean_code | buggy_code | tricky_code

# repo_root/skills/reference-author-clean/scripts/run.py
...
def main(argv: list[str]) -> int:
    ...
    if task is None:
        ...
        confidence = 0.0
        rationale = f"unknown task_id={task_id!r}; emitting degenerate stub for variant={VARIANT}"
    else:
